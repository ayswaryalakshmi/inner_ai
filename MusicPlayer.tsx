...
import JioSaavnMusicPlayer from './JioSaavnMusicPlayer';
...
const MusicPlayer: React.FC<MusicPlayerProps> = ({ 
  ...
  const [currentView, setCurrentView] = useState<'main' | 'categories' | 'playlist' | 'upload' | 'jiosaavn'>('main');
  const [showUploader, setShowUploader] = useState(false);
  const [showJioSaavnPlayer, setShowJioSaavnPlayer] = useState(false);
  ...
  const builtInTracks: Track[] = [
    ...
    },
    {
      id: 'Sahiba',
      title: 'LOVE',
      artist: 'Adithya Rikhari',
      emotion: 'peaceful',
      url: 'public/audio/Sahiba.mp3',
      duration: 480,
    ...
    },
    {
      ...
      artist: 'Sixth Sense',
      emotion: 'Motivated',
      url: 'public/audio/Starboy X Prayam.mp3',
      duration: 720,
      description: 'Flowing',
      emoji: '🏔️',
      category: 'nature'
    },
    {
      id: 'Romance',
      title: 'Trending',
      artist: 'Bengali Baddie',
      emotion: 'Obsession',
      url: 'public/audio/Obhodro Prem.mp3',
      duration: 540,
      description: 'lift your spirits and inspire hope',
      emoji: '🐦',
      category: 'nature'
    },
    ...
    // Instrumental - Healing Collection
    {
      ...
      artist: 'Adithya Rikhari',
      emotion: 'healing',
      url: 'public/audio/Aditya Rikhari - NASAMAJH.mp3',
      duration: 420,
    ...
    },
    {
      ...
      artist: '2hollis',
      emotion: 'joy',
      url: 'public/audio/2hollis poster boy.mp3',
      duration: 380,
      description: 'peak',
      emoji: '🎸',
      category: 'instrumental'
    ...
    {
      id: 'end of beginning',
      title: 'String Therapy',
      artist: 'Steve Hariton',
      emotion: 'healing',
      url: 'public/audio/end of begining.mp3',
      duration: 450,
      description: 'Soothing melodies for emotional restoration',
      emoji: '🎻',
      category: 'instrumental'
    },
  ...
  const categories = [
    ...
    { id: 'jiosaavn', name: 'JioSaavn', emoji: '🎧', description: 'Emotion-based JioSaavn recommendations' },
  ...
  const getFilteredTracks = (): Track[] => {
    ...
    switch (selectedCategory) {
      ...
      case 'jiosaavn':
        // This will open JioSaavn player instead
        return [];
      case 'favorites':
  ...
  const handleBackNavigation = () => {
    if (currentView === 'playlist') {
      ...
      setCurrentView('main');
    } else if (currentView === 'jiosaavn') {
      setCurrentView('categories');
    }
  };

  const handleCategoryClick = (categoryId: string) => {
    if (categoryId === 'jiosaavn') {
      setShowJioSaavnPlayer(true);
    } else {
  ...
  if (!isExpanded) {
    return (
      <>
        ...
        <div className="fixed bottom-20 right-4 z-30 transition-all duration-500 transform hover:scale-105">
          <div className="bg-white rounded-2xl shadow-2xl border-2 border-neutral-200 p-4 max-w-sm backdrop-blur-sm">
            ...
            <div className="mt-3 flex space-x-2">
              ...
              <button
                onClick={() => setShowJioSaavnPlayer(true)}
        ...
        {/* JioSaavn Music Player Modal */}
        <JioSaavnMusicPlayer
          currentEmotion={currentEmotion}
          isVisible={showJioSaavnPlayer}
          onClose={() => setShowJioSaavnPlayer(false)}
        />
